...
def test_import_does_not_load_openeye_runtime_modules(monkeypatch, tmp_path):
    """Importing oecluster should not import openeye.libs or openeye.oechem."""
    package = "oecluster"
    source_dir = tmp_path / package
    shutil.copytree("python/oecluster", source_dir, ignore=shutil.ignore_patterns("__pycache__"))
    ...
    (source_dir / "oecluster.py").write_text(
        "class _Stub:\n"
